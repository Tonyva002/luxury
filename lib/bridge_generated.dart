...
class RustImpl implements Rust {
  ...
  FlutterRustBridgeTaskConstMeta get kPublishTaggedDataBlockConstMeta =>
      const FlutterRustBridgeTaskConstMeta(
        debugName: "publish_tagged_data_block",
...
class RustWire implements FlutterRustBridgeWireBase {
  ...
  void wire_publish_tagged_data_block(
      int port_,
      ffi.Pointer<wire_uint_8_list> tag,
      ffi.Pointer<wire_uint_8_list> message,
      ) {
    return _wire_publish_tagged_data_block(
      port_,
      tag,
      message,
    );
  ...
  late final _wire_publish_tagged_data_blockPtr = _lookup<
      ffi.NativeFunction<
          ffi.Void Function(ffi.Int64, ffi.Pointer<wire_uint_8_list>,
              ffi.Pointer<wire_uint_8_list>)>>(
      'wire_publish_tagged_data_block');
  late final _wire_publish_tagged_data_block =
  _wire_publish_tagged_data_blockPtr.asFunction<
